    ...
    return (
      <div id='board-detail-top'>
        <div className='board-detail-top-header'>
          <div className='board-detail-title'>{'동해물과 백두산이 마르고 닳도록'}</div>
          <div className='board-detail-top-sub-box'>
            <div className='board-detail-write-info-box'>
              <div className='board-detail-writer-profile-image' style={{backgroundImage: `url(${defaultProfileImage})`}}></div>
              <div className='board-detail-writer-nickname'>{'자바맨'}</div>
              <div className='board-detail-info-divider'>{'\|'}</div>
              <div className='board-detail-writer-date'>{'2024.12.06'}</div>
            </div>
        ...
        <div className='board-detail-top-main'>
          <div className='board-detail-main-text'>{'되는 것인가'}</div>
          <img className='board-detail-main-image' src='https://img1.daumcdn.net/thumb/R1280x0/?fname=http://t1.daumcdn.net/brunch/service/user/6Na/image/aySupoB9n6H2vpBLC3KMfVZ2VCY.jpg' />
        </div>
      </div>
    );
